...
(function( root, factory ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_2903b1e4b69f1ee370a23c6d5fa451dde058e2b0": function($0, $1, $2, $3) {
                Module.STDWEB.from_js($0, (function(){var listener = Module.STDWEB.to_js($1); Module.STDWEB.to_js($2). addEventListener (Module.STDWEB.to_js($3), listener); return listener ;})());
            },
            "__extjs_723a63f6c9471ce085044c88a339d29c6ab586b1": function($0, $1) {
                Module.STDWEB.from_js($0, (function(){return Module.STDWEB.to_js($1). textContent ;})());
            },
            "__extjs_1b957ef03fc203d328eb998a560298bc21bfed05": function($0, $1) {
                Module.STDWEB.to_js($0). textContent = Module.STDWEB.to_js($1);
            },
            "__extjs_4912f5cc89c3eca19671b6d3f6a0a5be7b88cde8": function($0, $1) {
                Module.STDWEB.from_js($0, (function(){return Module.STDWEB.to_js($1). classList ;})());
            },
            ...
            "__extjs_52b5b7873851fc4c899090c8e7494211afb9da80": function($0) {
                return (Module.STDWEB.acquire_js_reference( $0 ) instanceof Element) | 0;
            },
            ...
            "__extjs_950b3bfe2fd25586ee03558f5206fdf6c9e4c10d": function($0, $1, $2) {
                Module.STDWEB.from_js($0, (function(){return Module.STDWEB.to_js($1). querySelectorAll (Module.STDWEB.to_js($2));})());
            },
            "__extjs_3c1ae374d5f093943f67b0d184630cbd65671700": function($0, $1) {
                Module.STDWEB.to_js($0). add (Module.STDWEB.to_js($1));
            },
            "__extjs_5a11f47b512ab587ca2fb5d042d5848cd26d77c3": function($0, $1) {
                Module.STDWEB.to_js($0). remove (Module.STDWEB.to_js($1));
            },
            "__extjs_f39a2110c6d8379dfa24eb1db2154619e03ecfac": function($0, $1, $2) {
                Module.STDWEB.from_js($0, (function(){return Module.STDWEB.to_js($1). contains (Module.STDWEB.to_js($2));})());
            },
            "__extjs_b9c6b0d338bdcb844f0da90a11b2cc0ebf3bd1cc": function($0, $1, $2) {
    ...
    function __load( instance ) {
        ...
        if( typeof module !== 'undefined' && module.exports ) {
            ...
            Rust.tic_tac_toe_wasm.exports = Module.exports;
        }
    ...
    if( Module.nodejs ) {
        ...
        const wasm_path = path.join( __dirname, "tic_tac_toe_wasm.wasm" );
        ...
        const __promise = fetch( "tic_tac_toe_wasm.wasm" )
            .then( response => response.arrayBuffer() )
            .then( bytes => WebAssembly.instantiate( bytes, __imports ) )
            .then( results => {
                __load( results.instance );
                console.log( "Finished loading Rust wasm module 'tic_tac_toe_wasm'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'tic_tac_toe_wasm':", error );
                throw error;
            });

        Rust.tic_tac_toe_wasm = __promise;
        return __promise;
    }
}));
